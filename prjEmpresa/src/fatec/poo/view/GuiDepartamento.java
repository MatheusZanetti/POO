...
public class GuiDepartamento extends javax.swing.JFrame {
    ...
    Derp = null;
    Derp = DaoDerp.consultar(txtSigla.getText().toUpperCase());
    ...
    if(Derp == null){
         ...
         txtNome.setText(Derp.getNome());
         txtSigla.setText(Derp.getSigla());
         txtSigla.setEnabled(false); 
         txtNome.setEnabled(true);
    ...
    DaoDerp = new DaoDepartamento(prepConec.abrirConexao());
    ...
    Derp = new Departamento(txtSigla.getText().toUpperCase(), txtNome.getText().toUpperCase());
    DaoDerp.inserir(Derp);
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
       if (JOptionPane.showConfirmDialog(null, "Confirma Alteração?")== 0){    //Sim
           Derp.setNome(txtNome.getText().toUpperCase());
           DaoDerp.alterar(Derp);
       }      
    ...
    private DaoDepartamento DaoDerp;
